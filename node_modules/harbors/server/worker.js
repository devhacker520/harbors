...
exports.request = function(req,res){
    ...
    t.end(function(){
        ...
        //都不存在，输出文件
        __file__.exists(path.join(r.config.dir,staticM)) ?
            ( r.display(staticM,true),harbors.log("匹配的文件"+staticM) ) :
            ( r.notFound(),harbors.log("没有匹配的文件") );
    });
