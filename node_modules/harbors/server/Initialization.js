...
try{
    harbors.vhost = harbors.Utils.merge(harbors.vhost,require('../../../config/vhost'));
}catch(err){
    harbors._devmodel&&console.log(err);
    harbors._devmodel&&console.log('User vhost file not found!');
}
