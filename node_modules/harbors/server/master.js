...
exports.createWorker = function(){
    console.log('harbors Service process started,Listening port:'+harbors.config.listenPort+'.Open the process number:'+harbors.config.clusterNum);
...
var Worker = function(){//创建工作进程
    var cp = cluster.fork();
    console.log('The promoter of new process. clusterid:'+cp.workerID+'. pid:'+cp.process.pid);
