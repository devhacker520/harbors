...
var app = {
    ...
    jadeTime:function(config){
        if(typeof(config.jadeTime)!='number'){
            console.log('config.jadeTime is not a number');
            error++;
        }else{
            if(config.jadeTime>1*60*60*1000){
                console.log('config.jadeTime cache time too long');
                warning++;
            }
        }
    },
