...
exports.createVirtualRoute = function(vhost,all){
    var virtualRouter = require('../lib/virtualRoute');
    for(var p in vhost){
        vhost[p]['route'] = virtualRouter.extraction(vhost[p],all);
    }
};
...
exports.createServer = function(config,hostList){
    http.createServer(function(req,res){
        ...
        //获取数据
//        _object(config,hostList[vhost],req,res,function($object){
//            console.log($object.cookie('test','123'));
//            console.log($object.cookie('test'));
//            $object.res.end('123');
//        });
