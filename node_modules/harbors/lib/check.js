...
var app = {
    ...
    serverType:function(config){
        if(config.vhost==false&&config.serverType!='dynamic'&&config.serverType!='static'&&config.serverType!='mixed'){
    ...
    cacheLevel:function(config){
        if(typeof(config.cacheLevel)!='number'||(config.cacheLevel!=0&&config.cacheLevel!=1&&config.cacheLevel!=2&&config.cacheLevel!=3)){
