...
harbors.Router = harbors.Class.extend({
    ...
    route: function(req, res){
        ...
        if(/\/$/.test(url)){
            ...
            for(var i=0;i<this._defaultFile.length;i++){
                if(this._routeTable[url + this._defaultFile[i]]){

                    this._routeTable[url + this._defaultFile[i]](req, res);
                    return;
                }
            }
    ...
    setDefault: function(fileArray){
        var _type = typeof fileArray;
        if(_type === 'object'){

            if(Array.isArray(fileArray)){
                this._defaultFile.concat(fileArray);
            }
        }else{
            this._defaultFile.push(fileArray);
