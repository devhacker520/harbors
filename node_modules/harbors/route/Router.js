...
harbors.Router = harbors.Class.extend({
    ...
    _route: function(){
        ...
        return function(req, res){
            ...
            harbors.log('Request url : %s', url);

            if(self._routeTable[url]){

                self._routeTable[url](req, res);
            }else{

                if(/\/$/.test(url)){

                    for(var i=0;i<self._defaultController.length;i++){
                        if(self._routeTable[url + self._defaultController[i]]){

                            self._routeTable[url + self._defaultController[i]](req, res);
                            return;
                        }
                    }
