...
//            throw 'error';
    ...
    fork: function(num){
        ...
        for(var i=num; i>0; i--){
            var _w = cp.fork(__dirname + '/Worker');

            _w.send(this, this.__server);
        }
    ...
    startServer: function(){
        ...
        if(this._protocol && protocol[this._protocol]){
            this.__server = protocol[this._protocol].createServer(function(req, res){
...
//            this.__handle = _S._handle;

            this.__server.listen(this._port, this._ip, this._callback);
        }
    }
