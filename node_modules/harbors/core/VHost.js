 ...
 */
harbors.vHost = harbors.VHost.create = function(handle){
    if(!handle){
        handle = function(req, res){
            this._notFoundHost(req, res);
        }
    }
    return new harbors.VHost(handle);
};