...
exports.MASTERPROCESS = function(){
    harbors.log('HARBORS child_process num is ', harbors._config.process);
    ...
    for(var i=0;i<harbors._config.process;i++){
        createWorker();
    }
};
        ...
        if(listenItem.vhostNum.length>1){
            var handle = function(req, res){
                ...
                if(domainList[req.headers.host] != void 0){
                    ...
                    exports.request(req, res, harbors._vhost[vhostNum]);
                    return void 0;
                }
                ...
                if(harbors._vhost[result]){
                    ...
                    exports.request(req, res, harbors._vhost[result]);
                    return undefined;
                }
                //没有匹配到虚拟主机的情况
            ...
            var handle = function(req, res){
                ...
                exports.request(req, res, harbors._vhost[listenItem.vhostNum[0]]);
            }
        }
        //创建服务对象
        if(listenItem.ip){
            harbors.log("Listen ", listenItem.ip, " ", listenItem.listen, " vhost num : ", listenItem.vhostNum);
            http.createServer(handle).listen(parseInt(listenItem.listen), listenItem.ip);
        }else{
            harbors.log("Listen ", listenItem.listen, " vhost num : ", listenItem.vhostNum);
            http.createServer(handle).listen(parseInt(listenItem.listen));
        }
    });
};

exports.request = function(req, res, config){
